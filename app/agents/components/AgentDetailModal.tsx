...
import { MeetingNoteAgentDetail } from './agent-details/MeetingNoteAgentDetail';
import { OrganizationCreationAgentDetail } from './agent-details/OrganizationCreationAgentDetail';
...
export function AgentDetailModal({ isOpen, agent, onClose, onAgentUpdate }: AgentDetailModalProps) {
  ...
  const renderAgentDetail = () => {
    switch (agent.id) {
      ...
      case 'meeting-note-agent':
        return <MeetingNoteAgentDetail agent={agent} onUpdate={handleModelUpdate} />;
      case 'organization-creation-agent':
        return <OrganizationCreationAgentDetail agent={agent} onUpdate={handleModelUpdate} />;
      default:
        return (
