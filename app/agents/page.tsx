...
import { MeetingNoteAgent } from '@/lib/agent-system/agents/MeetingNoteAgent';
import { OrganizationCreationAgent } from '@/lib/agent-system/agents/OrganizationCreationAgent';
  ...
  const initializeAgents = async () => {
    try {
      ...
      const agentClasses = {
        ...
        'meeting-note-agent': MeetingNoteAgent,
        'organization-creation-agent': OrganizationCreationAgent,
      };
      ...
      const defaultAgentIds = ['general-agent', 'search-agent', 'analysis-agent', 'generation-agent', 'validation-agent', 'meeting-note-agent', 'organization-creation-agent'];
      ...
      try {
        ...
        const defaultAgents = [
          ...
          { id: 'meeting-note-agent', instance: new MeetingNoteAgent() },
          { id: 'organization-creation-agent', instance: new OrganizationCreationAgent() },
        ];
