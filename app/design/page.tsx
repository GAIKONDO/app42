...
import { FileUploadSection } from '@/components/design/sections/FileUploadSection';
import { AIAssistantSection } from '@/components/design/sections/AIAssistantSection';
              ...
              >
                ...
                <DesignSectionProvider activeSection={activeSection}>
                  <div style={{ color: 'var(--color-text-light)', lineHeight: '1.8' }}>
                    ...
                    {activeSection === 'file-upload' && <FileUploadSection key={activeSection} />}
                    {activeSection === 'ai-assistant' && <AIAssistantSection key={activeSection} />}
                  </div>
