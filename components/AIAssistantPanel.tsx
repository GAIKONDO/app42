...
import { useAgentSelector } from './AIAssistantPanel/hooks/useAgentSelector';
...
import { AgentSelector } from './AIAssistantPanel/components/AgentSelector';
        ...
        <InputArea
          ...
          agentSelector={
            <AgentSelector
              ...
              setSelectedAgent={agentSelector.setSelectedAgent}
              showAgentSelector={agentSelector.showAgentSelector}
              setShowAgentSelector={agentSelector.setShowAgentSelector}
              availableAgents={agentSelector.availableAgents}
              loadingAgents={agentSelector.loadingAgents}
              onReload={agentSelector.loadAgents}
            />
          }
        />
                  </div>
