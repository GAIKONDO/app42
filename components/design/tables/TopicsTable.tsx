...
const columns: ColumnDefinition[] = [
  ...
  {
    name: 'companyId',
    description: '事業会社ID（外部キー、NULL可能、organizationsテーブルのtype="company"のレコードを参照）',
    pages: '/companies/detail, /rag-search, /knowledge-graph',
    relatedTables: 'organizations.id（type="company"の場合）',
  },
  {
    name: 'title',
  ...
  {
    name: 'imagePaths',
    description: '画像パスリスト（JSON配列）',
    pages: '/organization/detail/meeting',
    relatedTables: 'topicFiles.filePath',
  },
  {
    name: 'parentTopicId',
    description: '親トピックID（外部キー、NULL可能、階層構造用）',
    pages: '/organization/detail/meeting',
    relatedTables: 'topics.id（自己参照）',
  },
];
