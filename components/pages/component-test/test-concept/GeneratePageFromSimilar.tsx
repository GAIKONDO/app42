...
import { generatePageFromSimilar, generatePageFromTemplate, getAvailableOllamaModels } from '@/lib/pageGeneration';
...
export default function GeneratePageFromSimilar({
  ...
  // モデルタイプ選択（GPT/ローカル）
  const [modelType, setModelType] = useState<'gpt' | 'local'>('gpt');
                ...
                <div style={{ 
                  ...
                  <label style={{
                    ...
                    <input
                      ...
                      onChange={(e) => setModelType(e.target.value as 'gpt' | 'local')}
                      disabled={generating}
